package com.selsoft.servicerequest.email.service;
...
import com.selsoft.servicerequest.email.common.MailResponse;
...
public class MailSenderService {
	...
	public MailResponse sendMail(SimpleMailMessage msg) {
		...
		try {
			...
			helper.setFrom(environment.getProperty("mail.from"));
